...
def get_signal_statistics() -> SignalStatistics:
    ...
    return SignalStatistics(
        ...
        gross_missed_pnl_usd=float(missed.get("gross_missed_pnl_usd", 0)),
        gross_missed_loss_usd=float(missed.get("gross_missed_loss_usd", 0)),
        net_missed_pnl_usd=float(missed.get("net_missed_pnl_usd", 0)),
        net_missed_roe_pct=float(missed.get("net_missed_roe_pct", 0)),
